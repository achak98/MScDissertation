                                    ...
                                    for ks3 in range (args.cnn_window_size_large, ks2, -1):
                                        for stride6 in range (args.cnn_window_size_large, ks2, -1):
                                            ...
                                            for i in range (10):
                                                ...
                                                # Parse the arguments
                                                qwk_score_for_seed, test_loss_for_seed = baseline(args, embedding_type, stride1, stride2, stride3, stride4, stride5, stride6, ks1, ks2, ks3)
...
def baseline(args, embedding_type, stride1, stride2, stride3, stride4, stride5, stride6, ks1, ks2, ks3):
    ...
    qwk_score_for_seed, test_loss_for_seed =  evaluation.evaluate(model, test_dataloader)
