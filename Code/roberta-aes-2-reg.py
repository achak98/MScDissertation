...
Traceback (most recent call last):
  File "/home/achakravarty/Dissertation/Code/roberta-aes.py", line 302, in <module>
    train_loss, train_preds = test_step(model, cost_function, optimizer, train_loader)
                              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/achakravarty/Dissertation/Code/roberta-aes.py", line 242, in test_step
    outputs = model(inputs)
              ^^^^^^^^^^^^^
  File "/home/achakravarty/miniconda3/envs/dissertation/lib/python3.11/site-packages/torch/nn/modules/module.py", line 1501, in _call_impl
    return forward_call(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/achakravarty/Dissertation/Code/roberta-aes.py", line 182, in forward
    h = self.regressor2(h)
        ^^^^^^^^^^^^^^^^^^
  File "/home/achakravarty/miniconda3/envs/dissertation/lib/python3.11/site-packages/torch/nn/modules/module.py", line 1501, in _call_impl
    return forward_call(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/achakravarty/miniconda3/envs/dissertation/lib/python3.11/site-packages/torch/nn/modules/container.py", line 217, in forward
    input = module(input)
            ^^^^^^^^^^^^^
  File "/home/achakravarty/miniconda3/envs/dissertation/lib/python3.11/site-packages/torch/nn/modules/module.py", line 1501, in _call_impl
    return forward_call(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/achakravarty/miniconda3/envs/dissertation/lib/python3.11/site-packages/torch/nn/modules/linear.py", line 114, in forward
    return F.linear(input, self.weight, self.bias)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
RuntimeError: mat1 and mat2 shapes cannot be multiplied (1x4 and 512x256)
"""
