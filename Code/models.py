...
class Baseline(nn.Module):
    def __init__(self, args, stride1, stride2, stride3, stride4, stride5, stride6, ks1, ks2, ks3):
        ...
        self.pool1 = nn.MaxPool1d(kernel_size=ks1, stride=stride2)
        ...
        self.pool2 = nn.MaxPool1d(kernel_size=ks2, stride=stride4)
        ...
        self.pool3 = nn.MaxPool1d(kernel_size=ks3, stride=stride6)
