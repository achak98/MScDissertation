...
if os.path.exists('embeddings_d_2048.pt'):
    essay_embeddings = torch.load('embeddings_d_2048.pt')
    print(f"embeddings loaded from {'embeddings_d_2048.pt'}")
else:
    essay_embeddings = mean_encoding(dataset['essay'], roberta, tokenizer)
    torch.save(essay_embeddings, 'embeddings_d_2048.pt')
