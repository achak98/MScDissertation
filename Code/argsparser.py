...
def parse_args():
    ...
    parser.add_argument('--numOfWorkers', type=int, help='Number of Workers for Dataloaders')
    ...
    parser.add_argument('--log_interval', type= float, default = 0.4, help = 'Loggin Interval in Epochs')
